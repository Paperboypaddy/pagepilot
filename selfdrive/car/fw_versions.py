# hard-forked from https://github.com/commaai/openpilot/tree/05b37552f3a38f914af41f44ccc7c633ad152a15/selfdrive/car/fw_versions.py
import struct
import traceback
...
def match_fw_to_car_exact(fw_versions_dict):
  ...
  for candidate, fws in candidates.items():
    for ecu, expected_versions in fws.items():
      ...
      if ecu_type == Ecu.esp and candidate in (TOYOTA.SEDONA) and found_version is None:
        continue

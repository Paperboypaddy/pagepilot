// hard-forked from https://github.com/commaai/openpilot/tree/05b37552f3a38f914af41f44ccc7c633ad152a15/selfdrive/boardd/boardd.cc
...
Panda *usb_connect(const int fd, uint32_t index=0) {
  std::unique_ptr<Panda> panda;
  try {
